...
const Community = () => {
  ...
  const imageLikedToggle = async (id)=>{
    try {
          ...
          <div key={index} className='relative group inline-block pl-3 pt-3 w-full sm:max-w-1/2 lg:max-w-1/3'>
            ...
            '>
              ...
              <div className='flex gap-1 items-center'>
                ...
                <Heart onClick={()=> imageLikedToggle(creation.id)} className={`min-w-5 h-5 hover:scale-110 cursor-pointer ${creation.likes.includes(user.id) ? 'fill-red-500 text-red-500': 'text-white'}`}/>
              </div>
            </div>
