...
const BlogTitles = () => {
  const blogCategories = ['General', 'Technology', 'Buiness', 'Health', 'Lifestyle', 'Education', 'Travel', 'Food']
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <input onChange={(e) => setInput(e.target.value)} value={input} type="text" className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-200' placeholder='The futre of artificial intelligence is...' required />
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
        ...
        {!content ? (
          ...
          <div className='my-3h-full overflow-scroll text-sm text-slate-600'>
