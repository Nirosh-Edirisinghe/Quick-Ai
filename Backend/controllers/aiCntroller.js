...
export const generateImage = async (req, res) => {
  try {
    ...
    if (plan !== 'premium') {
      return res.json({ success: false, message: 'This feature is only avilable for premium subsriptions' })
    }
...
export const resumeReview = async (req, res) => {
  try {
    ...
    const prompt = `Review  the following resume and provide contructive feedback on its strengths, weakness and area for improvement.Resume Content:\n\n${pdfData.text}`
